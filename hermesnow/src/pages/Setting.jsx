...
import {step1Schema ,step2Schema , step3Schema} from '../validation/settingSchema'
        ...
        return (
          <div>
            ...
            <Input
              ...
              onBlur={formik1.handleBlur}
              className={
                formik1.touched.UserAge && formik1.errors.UserAge ? "error" : ""
              }
            />
        ...
        return (
          <div>
            ...
            <Input
              ...
              onBlur={formik3.handleBlur}
              className={
                formik3.touched.Gender && formik3.errors.Gender ? "error" : ""
              }
            />
  ...
  return (
    <SettingContainer>
      ...
      <Form>
        ...
        <ButtonContainer>
          {currentStep > 1 && (
            <PrevButton onClick={handlePrevStep}>قبلی</PrevButton>
          )}
